...
let btn = [{
                                ...
                                quickReplyButton: {
                                    displayText: 'Cara Pemesanan',
                                    id: 'format'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'list menu lain',
                                    id: 'menulain'
                                }  
                            }, {
                                quickReplyButton: {
                        ...
                        hisoka.send5ButImg(m.chat, anu, 'ARSTORE-ID', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        hisoka.send5ButGif(m.chat, anu, 'ARSTORE-ID', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        hisoka.send5ButVid(m.chat, anu, 'ARSTORE-ID', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        hisoka.send5ButMsg(m.chat, anu, 'ARSTORE-ID', btn)
                        } else if (setbot.templateLocation) {
                        hisoka.send5ButLoc(m.chat, anu, 'ARSTORE-ID', global.thumb, btn)
                        }
                     }
            break
            case 'marvelsuperwar': {
            	anu = `MARVEL SUPER WAR
==================
55Credits Rp 17.000
275Credits Rp 75.000
565Credits Rp 148.000
1155Credits Rp 294.000
1765Credits Rp 475.000
2950Credits Rp 741.000
6000Credits Rp 1.533.00
...
let btn = [{
            ...
            break
            case 'lol': {
            	anu = `LEAGUE OF LEGENDS:WILD RIFT
==================
...
let btn = [{
            ...
            break
            case 'apexlegend': {
            	anu = `APEX LEGENDS MOBILE
==================
90Syndicate Gold Rp 21.000
280Syndicate Gold Rp 40.000
500Syndicate Gold Rp 70.000
1050Syndicate Gold Rp 126.000
2150SyndicateGold Rp 251.000
5650Syndicate Gold Rp 597.000
11500Syndicate Gold Rp 1.300.000
23500Syndicate Gold Rp 2.400.000
SG proses 1-15 menit`
let btn = [{
                                urlButton: {
                                    displayText: 'Website',
                                    url: 'comingsoon'
...
420Points Rp 51.000
625Points Rp 68.000
1125Points Rp 118.000
1375Points Rp 151.000
1650Points Rp 168.000
1950Points Rp 201.000
2400Points Rp 252.000
2820Points Rp 310.000
3400Points Rp 337.000
4000Points Rp 411.000
...
let btn = [{
            ...
            break 
 case 'ragnarok': {          
 anu = `RAGNAROK M:ETERNAL LOVE
==================
36BCC Rp 79.000
145BCC Rp 313.000
373BCC Rp 781.000
748BCC Rp 1.570.000
1532BCC Rp 3.110.000
3993BCC Rp 7.512.000
9012BCC Rp 16.600.000
...
let btn = [{
           ...
           case 'ghensinimpact': {          
            anu = `GENSHIN IMPACT
==================
60Genesis Crystals Rp 21.000
330Genesis Crystals Rp 73.000
1090Genesis Crystals Rp 219.000
2240Genesis Crystals Rp 471.000
3880Genesis Crystals Rp 727.000
8080Genesis Crystals Rp 1.470.000
...
let btn = [{
            ...
            break
            case 'list': case 'menulain': case 'help': case '?': {
                anu = `┌──⭓ *Group Menu*
│
│⭔ ${prefix}linkgroup
